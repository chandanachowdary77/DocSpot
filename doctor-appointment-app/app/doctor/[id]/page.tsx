...
const doctorsData = [
...

  {
    ...
    service: "Skin & Cosmetic Care",
    availabilityDays: "Monday to Friday",
    availabilityTime: "10 AM To 5 PM",
  },

  {
    ...
    service: "Heart Specialist",
    availabilityDays: "Monday to Friday",
    availabilityTime: "11 AM To 6 PM",
  },
...

  {
    ...
    service: "Bone & Joint Care",
    availabilityDays: "Monday to Friday",
    availabilityTime: "10 AM To 4 PM",
  },
...

  {
    ...
    service: "Eye Care",
    availabilityDays: "Monday to Friday",
    availabilityTime: "11 AM To 5 PM",
  },

  {
    ...
    service: "Cancer Treatment",
    availabilityDays: "Monday to Thursday",
    availabilityTime: "12 PM To 6 PM",
  },
...

  {
    ...
    service: "Lung Specialist",
    availabilityDays: "Monday to Friday",
    availabilityTime: "10 AM To 6 PM",
  },
];
    ...
    >
      ...
      <nav className="dashboard-navbar">
        ...
        <div className="nav-center">
          ...
          <span className="nav-item">Records</span>
        ...
        <div className="doctor-details-card">
          ...
          <div className="doctor-top">
            <div>
              <h2>{doctor.name}</h2>
              <p className="specialty">{doctor.specialty}</p>
              <p className="qualification">MBBS , MS (Surgeon)</p>
          ...
          <div className="doctor-section">
            <h3>About Doctor</h3>
            <p>
              {doctor.experience} of experience in advanced medical
